...
-- 
-- Module: L2
-- Source Path: ANN/HDL_ANN/Classify/L2
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF L2 IS
  ...
  SIGNAL Add_out1                         : vector_of_signed18(0 TO 1);  -- sfix18_En12 [2]
  SIGNAL Add_out1_0                       : signed(17 DOWNTO 0);  -- sfix18_En12
  SIGNAL switch_compare_1                 : std_logic;
  SIGNAL Multiply_out1                    : vector_of_signed36(0 TO 1);  -- sfix36_En32 [2]
  SIGNAL Multiply_out1_dtc                : vector_of_signed18(0 TO 1);  -- sfix18_En12 [2]
  ...
  SIGNAL Leaky_ReLU_out1                  : vector_of_signed18(0 TO 1);  -- sfix18_En12 [2]
...
BEGIN
  ...
  Add_out1_gen: FOR t_08 IN 0 TO 1 GENERATE
    Add_out1(t_08) <= b_signed(t_08) + MatrixMultiply_out1(t_08);
  ...
  Multiply_out1_dtc_gen: FOR ii IN 0 TO 1 GENERATE
