...
for i = 1:5000
    ...
    [out_h1, w_h1, out_h2, w_h2, output] = forwardProp2(w1,w2,w3,x(:,q));
    ...
    [w1, w2, w3] = back_pro_leakyReLu(x(:,q), out_h1, w_h1, out_h2, w_h2, output, w1, w2, w3, y(q));
end

[out_h1, w_h1, out_h2, w_h2, output] = forwardProp2(best_w1, best_w2, best_w3, [1 1]');
output
[out_h1, w_h1, out_h2, w_h2, output] = forwardProp2(best_w1, best_w2, best_w3, [0 1]');
output
[out_h1, w_h1, out_h2, w_h2, output] = forwardProp2(best_w1, best_w2, best_w3, [1 0]');
output
[out_h1, w_h1, out_h2, w_h2, output] = forwardProp2(best_w1, best_w2, best_w3, [0 0]');
output
